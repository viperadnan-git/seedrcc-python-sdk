"""Legacy /oauth_test/* response models (dataclass-based)."""
...
class Torrent(_BaseModel):
    ...
    def from_dict(cls, data: dict) -> "Torrent":
        """Construct a `Torrent` from a raw API response dict."""
...
class File(_BaseModel):
    ...
    def from_dict(cls, data: dict) -> "File":
        """Construct a `File` from a raw API response dict."""
        instance = cls(
...
class Folder(_BaseModel):
    ...
    def from_dict(cls, data: dict) -> "Folder":
        """Construct a `Folder` from a raw API response dict."""
        instance = cls(
...
class UserSettings(_BaseModel):
    ...
    def from_dict(cls, data: dict) -> "UserSettings":
        """Construct a `UserSettings` from a raw API response dict."""
        instance = cls(
...
class ScannedTorrent(_BaseModel):
    ...
    def from_dict(cls, data: dict) -> "ScannedTorrent":
        """Construct a `ScannedTorrent` from a raw API response dict."""
        instance = cls(
            id=data.get("id", 0),
            hash=data.get("hash", ""),
            size=data.get("size", 0),
...
class ListContentsResult(Folder):
    ...
    def from_dict(cls, data: dict) -> "ListContentsResult":
        """Construct a `ListContentsResult` from a raw API response dict."""
...
class ScanPageResult(_BaseModel):
    ...
    def from_dict(cls, data: dict) -> "ScanPageResult":
        """Construct a `ScanPageResult` from a raw API response dict."""
        instance = cls(
...
class TorrentProgress(_BaseModel):
    ...
    def from_dict(cls, data: dict) -> "TorrentProgress":
        """Construct a `TorrentProgress` from a raw API response dict."""
        instance = cls(
            title=data.get("title", ""),
            size=data.get("size", 0),
