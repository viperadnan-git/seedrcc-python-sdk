# DO NOT EDIT — generated from src/seedrcc/legacy/async_client.py by scripts/gen_sync.py.
# Run `python scripts/gen_sync.py` (or rebuild the package) to regenerate.

"""Legacy /oauth_test/* async client, kept for backward compatibility."""
...
class Seedr:
    ...
    def get_device_code() -> models.DeviceCode:
        ...
        with httpx.Client() as client:
            response = Seedr._make_http_request(
                client, "get", constants.DEVICE_CODE_URL, params=params.to_dict()
            )
        ...
        **httpx_kwargs: Any,
        ...
        def auth_callable(client: httpx.Client) -> Dict[str, Any]:
            ...
            return cls._authenticate_and_get_token_data(
                client,
                "get",
                constants.DEVICE_AUTHORIZE_URL,
    ...
    def batch_delete(
        ...
        response_data = self._cookie_api_request("post", "/fs/batch/delete", data=data)
        return models.APIResult.from_dict(response_data)
    ...
    def _api_request(
        ...
        **kwargs: Any,
        ...
        url = kwargs.pop("url", constants.RESOURCE_URL)
    ...
    def _cookie_api_request(
        ...
        url = f"{constants.COOKIE_BASE_URL}{path}"
        request_kwargs: Dict[str, Any] = {"headers": constants.COOKIE_HEADERS}
    ...
    def _cookie_login(
        ...
        response = Seedr._make_http_request(
            ...
            headers=constants.COOKIE_HEADERS,
        )
    ...
    def _refresh_access_token(self) -> models.RefreshTokenResult:
        ...
        if self._token.refresh_token:
            ...
            response = self._make_http_request(
                self._client, "post", constants.TOKEN_URL, data=payload.to_dict()
            )
    ...
    def __enter__(self) -> "Seedr":
        """Return self; lifecycle is purely on `__aexit__`."""
        return self
